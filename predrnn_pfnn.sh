...
python -u run.py \
    ...
    --save_dir checkpoints/onecycle_pool \
    --gen_frm_dir results/onecycle_pool \
    ...
    # --pretrained_model /home/aurelia/data/workspace/ParFlow-nn/checkpoints/onecycle_kernel3/model.ckpt-80000 
